      ...
      <div className='max-w-5xl mx-auto space-y-6'>
        <div className='bg-white rounded-lg shadow-sm p-4 md:p-6 flex items-center gap-4'>
          ...
          <div>
            ...
            <p className='text-sm text-slate-500'>
              Add color names here only. Upload color photos on each product (Attributes tab).
            </p>
          </div>
        </div>
        ...
        <form className='space-y-6' onSubmit={e => { e.preventDefault(); handleSubmit(); }}>
          <Card className='bg-white border border-slate-200 p-6 space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-xs text-muted-foreground mt-1'>
                Shape style for how options appear on the storefront.
              </p>
          ...
          <div className='flex justify-end gap-3'>
            <Button type='button' variant='outline' onClick={() => router.push('/supplier/attributes')} disabled={saving}>
              Cancel
            </Button>
