  ...
  return (
    <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        ...
        <Button onClick={() => router.push('/supplier/cms/seasonal-banners/add')} className='gap-2 bg-[#22c55e]'>
                ...
                <TableRow key={banner._id} className='border-b border-gray-200 hover:bg-green-50 transition-colors duration-150'>
                  ...
                  <TableCell className='py-4'>
                    <div className='flex justify-end gap-6'>
                      <button
                        onClick={() => router.push(`/supplier/cms/seasonal-banners/edit/${banner._id}`)}
